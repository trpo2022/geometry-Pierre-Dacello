...
int plosh_treug(float x_krug, float y_krug, float radius, float x1_treugol, float y1_treugol, float x2_treugol, float y2_treugol, float x3_treugol, float y3_treugol)
{
	float a,b,c,S,p;
	...
	printf("/nPloshad treugolnika%f",S);
	return S;
}
